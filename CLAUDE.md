...
This project has agent skills defined under `.cursor/skills/`:

- `conventional-commits` — writes commit messages following project commitlint rules
- `unit-test-writer` — generates Vitest unit tests matching project patterns