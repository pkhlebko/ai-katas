...
**Northstar Travel** — a React 19 + TypeScript travel planning SPA with full internationalization.
...
- `src/i18n/locales/`: full translation files (TypeScript) — includes labels, destination data, FAQs, guides, and policy text
...
This is the **reference solution** for Kata 2 (Internationalization). The starting point is `kata-2-start`.
